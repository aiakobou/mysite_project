                ...
                function (t, e, n) {
                    function r(t, e) {
                        ...
                        var n,
                            ...
                            p = r.id;
                        return (
                            e.forceNew || e["force new connection"] || !1 === e.multiplex ? (a("ignoring socket cache for %s", i), (n = s(i, e))) : (c[p] || (a("new io instance for %s", i), (c[p] = s(i, e))), (n = c[p])), n.socket(r.path)
                        );
                    }
                    var o = t("./url"),
                ...
                function (t, e, n) {
                    ...
                    i(r.prototype),
                        ...
                        (r.prototype.emit = function (t) {
                            ...
                            var r = { type: n, data: e };
                            return (
                                "function" == typeof e[e.length - 1] && (p("emitting packet with ack id %d", this.ids), (this.acks[this.ids] = e.pop()), (r.id = this.ids++)), this.connected ? this.packet(r) : this.sendBuffer.push(r), this
                            );
                        }),
                    ...
                    (function (n) {
                        function r(t, e) {
                            ...
                            if (
                                ...
                                t && ((t = u(t)), (e.host = t.host), (e.secure = "https" == t.protocol || "wss" == t.protocol), (e.port = t.port), t.query && (e.query = t.query)),
                        ...
                        (e.exports = o),
                            ...
                            (i.prototype.create = function () {
                                ...
                                var e = (this.xhr = new a(t)),
                                    r = this;
                                try {
                                    if ((f("xhr open %s: %s", this.method, this.uri), e.open(this.method, this.uri, this.async), this.supportsBinary && (e.responseType = "arraybuffer"), "POST" == this.method))
                                        try {
                            ...
                            function c(t) {
                                ...
                                return (
                                    0 == (4294965248 & t)
                                        ...
                                        : 0 == (4292870144 & t) && ((e = b(((t >> 18) & 7) | 240)), (e += a(t, 12)), (e += a(t, 6))),
                                    (e += b((63 & t) | 128))
                                );
                            }
                            function p(t) {
                    ...
                    (function (t) {
                        ...
                        e.exports = function (e) {
                            return "string" == typeof e && e
                                ? ((e = e.replace(s, "").replace(a, "")), t.JSON && JSON.parse ? JSON.parse(e) : n.test(e.replace(r, "@").replace(o, "]").replace(i, "")) ? new Function("return " + e)() : void 0)
                                : null;
                        };
                    }.call(this, "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}));
                },
            ...
            36: [
                function (t, e) {
                    ...
                    e.exports = function (t) {
                        ...
                        return (
                            -1 != o && -1 != i && ((a.source = e), (a.host = a.host.substring(1, a.host.length - 1).replace(/;/g, ":")), (a.authority = a.authority.replace("[", "").replace("]", "").replace(/;/g, ":")), (a.ipv6uri = !0)), a
                        );
                    };
                },
                {},
                ...
                function (t, e, n) {
                    ...
                    (n.protocol = 4),
                        ...
                        (s.prototype.add = function (t) {
                            var e;
                            if ("string" == typeof t)
                                (e = a(t)), n.BINARY_EVENT == e.type || n.BINARY_ACK == e.type ? ((this.reconstructor = new c(e)), 0 === this.reconstructor.reconPack.attachments && this.emit("decoded", e)) : this.emit("decoded", e);
                            else {
                                ...
                                var P,
                                    ...
                                    U = function (t) {
                                        ...
                                        if (("$" == t && q(), "string" == typeof t)) {
                                            ...
                                            if ("{" == t) {
                                                for (e = {}; (t = D()), "}" != t; n || (n = !0))
                                                    n && ("," == t ? ((t = D()), "}" == t && q()) : q()), ("," == t || "string" != typeof t || "@" != (b ? t.charAt(0) : t[0]) || ":" != D()) && q(), (e[t.slice(1)] = U(D()));
                                                return e;
                                            }
                                            q();
                                        }
